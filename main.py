#karthik komati
#this file is for task 1 of the project
...
#the neural net class that is used in this project
class Net(nn.Module):
    def __init__(self):
...
def main(argv):
    ...
    for filename in os.listdir("myNumbers"):
        # print(filename)
        img = cv2.imread(os.path.join("myNumbers", filename))
        dim = (28, 28)
        ...
        outs.append(out.data.max(1, keepdim=True)[1].item())
